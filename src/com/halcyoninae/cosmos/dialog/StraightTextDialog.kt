...
class StraightTextDialog(content: String?) : JFrame(), Runnable {
    ...
    init {
        ...
        text = JEditorPane("text/html", content)
        text.isEditable = false
        text.isFocusable = false
        pane = JScrollPane(text)
        pane.preferredSize = Dimension(250, 100)
        pane.viewport.preferredSize = Dimension(250, 100)
