 ...
 * @since 3.0
 */
class ForceMaxSize(MAX_WIDTH: Int, MAX_HEIGHT: Int, MIN_WIDTH: Int, MIN_HEIGHT: Int) : ComponentListener {
    private var a = 0
    private var b = 0
    private var c = 0
    private var d = 0
    ...
    override fun componentResized(e: ComponentEvent) {
        ...
        if (de.width < d) {
            de.setSize(d, de.height)
        }
        if (de.height < c) {
            de.setSize(de.width, c)
        }
    }
