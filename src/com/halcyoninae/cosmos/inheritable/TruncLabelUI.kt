...
class TruncLabelUI constructor() : BasicLabelUI() {
    /**
     * @return int
     */
    var before: Int = 0
    ...
    override fun layoutCL(
        l: JLabel, fontMetrics: FontMetrics, text: String, icon: Icon, viewR: Rectangle, iconR: Rectangle,
        textR: Rectangle
    ): String {
        before = text.length
        val s: String = super.layoutCL(
