 ...
 * @since 3.2
 */
class MinimizePlayer : JButton(), BBlocButton {
    private val player: MiniPlayer
    private var pressed = false

    init {
        icon = resizeImage(
            Global.rd.getFromAsImageIcon(Manager.BBLOC_MINIMIZED_PLAYER),
            16,
            16
        )
        toolTipText = "Launch the audio player in a mini display form factor"
