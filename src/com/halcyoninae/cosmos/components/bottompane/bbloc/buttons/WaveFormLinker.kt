 ...
 * @since 3.2
 */
class WaveFormLinker : JButton(), BBlocButton {
    private val pane: WaveFormPane? = null

    init {
        icon = resizeImage(
            Global.rd.getFromAsImageIcon(Manager.RSC_FOLDER_NAME + "/bbloc/dots.png"),
            16,
            16
        )
        rolloverIcon = resizeImage(
            Global.rd.getFromAsImageIcon(Manager.RSC_FOLDER_NAME + "/bbloc/dots_pressed.png"),
            16,
            16
        )
        ...
        toolTipText = "WaveForm display Currently Unavailable due to technical issues"
        isEnabled = false
    }
