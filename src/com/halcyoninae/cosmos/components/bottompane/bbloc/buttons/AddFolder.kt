 ...
 * a folder from the
 * [com.halcyoninae.cosmos.dialog.SelectApplicableFolders]
 * instance.
 *
 * @author Jack Meng
 ...
 * @since 3.0
 */
class AddFolder : JButton(resizeImage(Global.rd.getFromAsImageIcon(Manager.ADDFOLDER_BUTTON_DEFAULT_ICON), 16, 16)),
    BBlocButton {
    init {
        rolloverIcon = resizeImage(
            Global.rd.getFromAsImageIcon(Manager.ADDFOLDER_BUTTON_PRESSED_ICON),
            16,
            16
        )
        toolTipText = Manager.ADDFOLDER_BUTTON_TOOLTIP
        isOpaque = true
        background = null
        border = null
