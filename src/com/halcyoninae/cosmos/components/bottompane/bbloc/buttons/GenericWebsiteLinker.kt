...
object GenericWebsiteLinker {
     ...
     * @return
     */
    fun getButton(url: String?, tooltip: String?, icon: ImageIcon?): BBlocButton {
        return WebsitePage(tooltip, icon, url)
    }

    class WebsitePage(tooltip: String?, ico: ImageIcon?, url: String?) : JButton(
        resizeImage(
            ico!!, 16, 16
        )
    ), BBlocButton {
