 ...
 * @since 3.2
 */
class SlidersControl : JButton(), BBlocButton {
    private val dialog: SlidersDialog
    private var isPressed: Boolean

    init {
        icon = resizeImage(Global.rd.getFromAsImageIcon(Manager.SLIDERS_BUTTON_DEFAULT_ICON), 16, 16)
        toolTipText = "Open a window to display sliders that can alter certain things"
        isOpaque = true
        border = null
