 ...
 * @since 3.2
 */
class AudioSettings : JScrollPane(), SettingsTabs {
    private val panel: JPanel
    private val i = 0

    init {
        preferredSize = Dimension(Manager.SETTINGS_MIN_WIDTH, Manager.SETTINGS_MIN_HEIGHT)
         ...
         * }
         */
        val str = arrayOfNulls<String>(ProgramResourceManager.propertiesList.size)
        var i = 0
        for (p in filterProperties(
            "audio", PropertyFilterType.STARTS_WITH,
     ...
     * @return JComponent
     */
    override val tabContent: JComponent
        get() = this
}