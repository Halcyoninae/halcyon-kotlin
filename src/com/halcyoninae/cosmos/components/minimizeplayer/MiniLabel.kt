 ...
 * @since 3.1
 */
class MiniLabel constructor(textstart: String, textproper: String, textend: String) :
    JLabel(textstart + textproper + textend) {
    private val textproper: String?
    private val ellipsis: String? = "..."
    private val insetsHorizontal: Int
    private var textproperwidth: Int = 0
    private var fontMetrics: FontMetrics
    private var ellipsisWidth: Int = 0
    private var borderHorizontal: Int = 0
    ...
    init {
        ...
        addComponentListener(object : ComponentAdapter() {
            public override fun componentResized(e: ComponentEvent) {
                val availablewidth: Int = getWidth()
                if (textproperwidth > availablewidth - (insetsHorizontal + borderHorizontal)) {
                    var clippedtextproper: String = textproper
     ...
     * @param font
     */
    public override fun setFont(font: Font) {
        super.setFont(font)
        fontMetrics = getFontMetrics(getFont())
        calculateWidths()
    }
     ...
     * @return String
     */
    private fun clipText(clippedtextproper: String): String {
     ...
     * @param border
     */
    public override fun setBorder(border: Border) {
