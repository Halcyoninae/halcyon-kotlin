 ...
 * @since 3.2
 */
class MiniPlayer constructor() : JFrame(), Runnable {
    private val pane: MiniContentPane
    private var pX: Int = 0
    private var pY: Int = 0

    @Transient
    private var listener: MiniPlayerListener? = null
    ...
    init {
        ...
        addMouseListener(MiniPlayerClickMenu(this))
        setResizable(true)
    }
     ...
     * @param listener
     */
    fun setMiniPlayerListener(listener: MiniPlayerListener?) {
