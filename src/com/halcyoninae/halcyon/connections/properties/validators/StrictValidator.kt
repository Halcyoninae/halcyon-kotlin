 ...
 * @since 3.2
 */
class StrictValidator(vararg allowedArgs: String) : PropertyValidator {
    var tempaltes: Array<String>

    init {
        tempaltes = allowedArgs as Array<String>
    }
    ...
    override fun isValid(propertyValue: String): Boolean {
        for (template in tempaltes) {
            if (propertyValue.equals(template, ignoreCase = true)) {
                return true
            }
        }
        return false
